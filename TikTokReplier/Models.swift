...
struct AppConfig: Codable {
    ...
    var lmStudioModel: String = "qwen3.6-35b-a3b"
    var ollamaModel: String = "qwen3:35b-a3b"
    ...
    var activeURL: String { backend == .lmStudio ? lmStudioURL : ollamaURL }
    var activeModel: String { backend == .lmStudio ? lmStudioModel : ollamaModel }
